...
public class ShowAllPlayerPanel extends JPanel {
	...
	MyTable myAllPlayerTable = new MyTable(allPlayerTable);
	{
		...
		myAllPlayerTable.getTableHeader()
	...
	private JPanel HeaderPanel() {
		...
		character[0].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "A"));
		character[1].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "B"));
		character[2].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "C"));
		character[3].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "D"));
		character[4].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "E"));
		character[5].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "F"));
		character[6].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "G"));
		character[7].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "H"));
		character[8].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "I"));
		character[9].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "J"));
		character[10].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "K"));
		character[11].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "L"));
		character[12].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "M"));
		character[13].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "N"));
		character[14].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "O"));
		character[15].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "P"));
		character[16].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "Q"));
		character[17].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "R"));
		character[18].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "S"));
		character[19].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "T"));
		character[20].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "U"));
		character[21].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "V"));
		character[22].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "W"));
		character[23].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "X"));
		character[24].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "Y"));
		character[25].addActionListener(e -> setTable(
				(String) newOrOld.getSelectedItem(), "Z"));
		...
		playerNameTextField.addKeyListener(new KeyAdapter() {
			public void keyPressed(KeyEvent e) {
				if (e.getKeyChar() == KeyEvent.VK_ENTER) {
					if (newOrOld.getSelectedItem().equals("退役")) {
		...
		findPlayerAccordingTeam.setBounds(100 + 26 * 30 + 5
				+ (FrameSize.width - 26 * 30 - 100) / 2 - 10 + 5, 5,
				(FrameSize.width - 26 * 30 - 100) / 2 - 10, 30);
		findPlayerAccordingTeam
				.addActionListener(e -> setNowPlayerTable(playerController
						.getPlayerOfTeam((String) findPlayerAccordingTeam
								.getSelectedItem())));
	...
	private void setTable(String playerType, String playerStart) {
		if (playerType.equals("退役")) {
			setOldPlayerTable(playerController.getPlayersWithStart(2014,
					playerStart));
		} else {
			try {
				setNowPlayerTable(playerService
						.fuzzilySearchAvtivePlayerPO(playerStart));
			} catch (RemoteException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	private void setNowPlayerTable(PlayerPO[] playerVOs) {
		if (playerVOs != null) {
			...
			myAllPlayerTable.getColumnModel().getColumn(1)
					.setPreferredWidth(130);
			myAllPlayerTable.getColumnModel().getColumn(6)
