...
public class PlayerController implements PlayerBlService {
	...
	public Image getLineChartImage(int season, String playername) {
		...
		if(regularP == null && playeroffP == null){
			...
			PTS.append(newest[10].getPoints());
			REB.append(newest[10].getRebs());
			AST.append(newest[10].getHelp());
			FT.append(newest[10].getPenaltyHandNo() != 0 ? newest[10].getPenaltyHitNo()/newest[10].getPenaltyHandNo()*100 : 0);
			PT3.append(newest[10].getThreeHandNo() != 0? newest[10].getThreeHitNo()/newest[10].getThreeHandNo()*100 : 0);
